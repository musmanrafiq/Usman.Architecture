...
- tool-first tutorials that explain *how* but rarely *why*
...
It will contain:
- **Architecture topics** that explain *why* and *when*, not just *how*
...
- it becomes hard to explain *why* things exist the way they do
